...
import type { Groups, Rule, RuleObject } from '../types/Rule'
...
// export const GROUPS_DT: Groups = Array.from(generator_adjacent_pos('king'))

const Rule_ID_Has_Group = ['[R]', '[C]', '[B]', '[SG]'] as const
